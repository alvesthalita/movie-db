...
import com.thalita.movie_db_app.core.ServiceMovie
...
//        requestMovieList()
    ...
    private fun requestMovieList() {
        ...
        val serviceMovie = ServiceMovie(context, url)
...
//        adapter=MovieListAdapter(context, result)
//        movieList.setAdapter(adapter)
//        movieList.setOnItemClickListener(OnItemClickListener { parent: AdapterView<*>?, view: View?, position: Int, id: Long ->
